        ...
        <div class="service_container">
            <div class="container ">
                <div class="heading_container">
                    <h2>
                        INFORMASI <span>KORBAN</span>
                    </h2>
                    <p>
                        Jumlah korban yang disebabkan oleh tanah longsor di Poncokusumo
                    </p>
                </div>
                <div class="row">
                    <div class="col-md-6 ">
                        <div class="box ">
                            <div class="detail-box">
                                <h5>
                                    Kejadian Tanggal 1-3 November 2022
                                </h5>
                                <p>
                                    Jumlah Luka Ringan: 50
                                </p>
                                <p>
                                    Jumlah Luka Berat: 3
                                </p>
                    ...
                    <div class="col-md-6 ">
                        <div class="box ">
                            <div class="detail-box">
                                <h5>
                                    Kejadian Tanggal 22 Agustus 2022
                                </h5>
                                <p>
                                    Jumlah Luka Ringan: 50
                                </p>
                    ...
                    <div class="col-md-6 ">
                        <div class="box ">
                            <div class="detail-box">
                                <h5>
                                    Kejadian Tanggal 15 April 2022
                                </h5>
                                <p>
                                    Jumlah Luka Ringan: 50
                                </p>
                    ...
                    <div class="col-md-6 ">
                        <div class="box ">
                            <div class="detail-box">
                                <h5>
                                    Kejadian Tanggal 31 Januari 2022
                                </h5>
                                <p>
                                    Jumlah Luka Ringan: 50
                                </p>
